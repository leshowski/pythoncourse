...
button1 = Button(window, text="Check",width=20,command=answerChech,bg="#75DA88")
button1.pack(pady=40)

button2 = Button(window, text="Reset",width=20,command=resetSwitch,bg="#DE4839")
button2.pack()
